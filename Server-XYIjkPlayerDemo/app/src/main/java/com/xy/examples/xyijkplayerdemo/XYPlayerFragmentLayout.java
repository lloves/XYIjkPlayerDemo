...
public class XYPlayerFragmentLayout extends FrameLayout {
    ...
    public XYPlayerFragmentLayout(@NonNull Context context) {
        this(context, null);
    }

    public XYPlayerFragmentLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XYPlayerFragmentLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
